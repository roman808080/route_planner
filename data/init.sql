...
CREATE SEQUENCE roads_id_seq INCREMENT 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1;

CREATE TABLE "public"."roads" (
    "id" integer DEFAULT nextval('roads_id_seq') NOT NULL,
...
INSERT INTO
    "cities" ("id", "name", "lattitude", "longitude")
VALUES
    (2, 'TestCity0', 0, 0),
    (3, 'TestCity1', 0, 0),
    (4, 'TestCity2', 0, 0),
